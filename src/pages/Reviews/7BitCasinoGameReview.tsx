                    ...
                    <div className="flex flex-col">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{color: "green"}}/>
                                        <div>
                                            <span className="font-bold">Weekend Cashback</span>: The weekend is for second chances. That’s why you can get cashback offers from 5 to 20%.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{color: "green"}}/>
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div>
                                        They are available 24/7 through email and live chat and they’re always happy to help.
                                    </div>
                                    <div>
                        ...
                        <div id="faq-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            ...
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                {openFAQ3 &&
                                    <div className="text-black mt-5">
                                        Yes! <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">7Bit Casino</a> is licensed by the government of Curaçao and offers provably fair games where you can verify the outcome of every game round yourself.
                                    </div>
                                }
                            </div>
                        </div>
