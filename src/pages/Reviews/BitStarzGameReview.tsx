                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div>
                                        As soon as you create an account at BitStarz, you <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600"></a>unlock 20 Free Spins to test the product. The spins are all yours simply for signing up; no deposit nor BitStarz bonus code is required.
                                    </div>
                                    <div>
