                    ...
                    <div className="flex flex-col">
                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div className="text-base">
                                        After signing up at 1xSlots, you get a lot of opportunities to get your hands on some extra cash to play with. And you’ll need it, considering the amount of slots you get to choose from.
                                    </div>
                                    <div>
                                    ...
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{color: "green"}}/>
                                        <div>
                                            <span className="font-bold">Special Treat Wednesday</span>: It’s that day of the week, the beginning is over but the end is not yet in sight. To soften the pain, you get a chance to obtain some free spins on Wednesdays.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{color: "green"}}/>
                                    ...
                                    <div>
                                        You can also decide to sign up for the loyalty program. Here you start at the 1st of 8 levels, which is Copper. The more you play, the faster you'll progress. And of course, every new level brings a lot of great benefits. So make sure to sign up if cashbacks, VIP treatments and more extra’s sound good to you.
                                    </div>
                                </div>
                        ...
                        <div id="lookFeel-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        The emphasis upon entering the casino lies on bonuses and pretty women. If you like these two things, which is likely, you’ll probably enjoy yourself at 1xSlots. However, the casino does seem to target men more actively than women.
                                    </div>
                                    <div>
                                        On the homepage you are treated with plenty of women, but once you navigate away from there it’s mostly what you came for; casino games. The design throughout the casino has a very luxurious feel to it, as if you just walked into a VIP room.
                                    </div>
                        ...
                        <div id="gameSelection-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        It’s difficult to start describing the selection of more than 7,000 games, available in 61 different languages. You can, however, rest assured. All your favorite games are available at this casino. From big providers like NetEnt, Play 'N Go, Microgaming, Quickspin, and more to the underdog like Swintt, Fazi and others.
                                    </div>
                                    <div>
                                        It’s likely to find many games to your liking and, thanks to the great game offer that only continues to grow, you’ll be the first to be able to play new games at 1xSlot. So play Dead or Alive, BerryBurst, Break da Bank, Hot Sync, or the newer Everlasting Spins and Aloha Charm.
                                    </div>
                                    ...
                                    <div>
                                        The only disadvantage of having such a big amount of games to choose from is that it’s not easy to find them by category. However, you will find a couple of provably fair games in the games section.
                                    </div>
                                    <div>
                                        When it comes to jackpot slots, you’ll be pleasantly surprised by the offer. All of the great NetEnt jackpots are on offer, but that is definitely not all. 
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        As Evolution Gaming is one of the providers, you don’t have to worry about variety in the live casino. This also goes for the choice in video poker games.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div>
                                        The only downside is that the casino is restricted in some countries, like the US, the Netherlands, France, the Dutch Antilles and Curaçao. This basically goes for all countries in which online gaming is illegal or not yet regulated. It holds a Curaçao license.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        Of course it’s normal that questions pop up every now and then. Especially if you’re new to the online casino world. You have three ways to get in touch with the always helpful support team that’s available 24/7.
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
