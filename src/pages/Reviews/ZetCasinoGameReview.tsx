...
// review images
import reviewImg1 from "../../Assets/images/reviews/26-zetcasino-game/1-zetcasino-review.png";
import reviewImg2 from "../../Assets/images/reviews/26-zetcasino-game/2-zetcasino-review.png";
import reviewImg3 from "../../Assets/images/reviews/26-zetcasino-game/3-zetcasino-review.png";

// country flag
import { GB, IN, PT, RU, FI, DE, NO, IT, HU, PL } from 'country-flag-icons/react/1x1';
...
const ZetCasinoGameReview = () => {
    const siteData = siteDatas[25];
                    ...
                    <div className="flex flex-col">
                            ...
                            <div className="flex flex-row gap-x-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-base">
                                        Play the best games while enjoying the best bonuses and fastest payouts
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                                ...
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Want a welcome bonus? You only have to ask...
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div className="text-base">
                                        It's always nice to have a warm welcome, isn't it?
                                    </div>
                                    <div>
                                        ZetCasino greets you with a cheerful message and a <span className="font-bold">100% deposit bonus of up to €500 and 200 free spins</span>. Here's how it works:
                                    </div>
                                    <div className="text-base">
                                        <Timeline position="right">
                                            ...
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Contact customer support to unlock your bonus.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                            ...
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Immediately get up to €500 in bonus.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Receive 20 free spins a day for 10 days.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                        </Timeline>
                                    ...
                                    {/*  */}
                                    <div>
                                        Although the $500 bonus is relatively humble when compared with the welcome packages at other blockchain casinos, the 200 free spins are an exciting additional treat.
                                    </div>
                                    <div>
                                        We're not huge fans of the extra step of having to contact customer support to unlock the offer, but our experience was positive.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Other ZetCasino Bonuses
                                    </div>
                                    <div>
                                        With its delectable smorgasbord of promotions, there's never a dull moment at ZetCasino. There are offers for all tastes and several tournaments and challenges that reward the most daring.
                                    </div>
                                    <div>
                                        Unfortunately, you must always contact customer support before the offers become available to you.
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Weekly Reload Bonus</span>: Every week from Monday till Thursday, you can get 50 free spins on your next deposit. 
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Weekend Reload Bonus</span>: During weekends, you can unlock a 50% bonus up to €700 and 50 free spins€
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Weekly 15% Cashback</span>: Contact customer support to discover what you are entitled to; the limit is 15% up to €3,000.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Live Casino 10% Cashback</span>: Live casino players can also get a 10% up to $150 cashback through the live chat.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Drops & Wins</span>: You can win daily prizes in tournaments that run from Thursday to Wednesday.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Tournaments</span>: ZetCasino is always organizing other tournaments where you can win extra prizes.
                                        </div>
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        ZetCasino's VIP Program
                                    </div>
                                    <div>
                                        Get treated like a king or queen on ZetCasino's five-tiered VIP program.
                                    </div>
                                    <div>
                                        For instance, Zeta players (the highest level) are entitled to:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                    ...
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            €20,000 monthly withdrawal limit
                                        </div>
                                    </div>
                                    <div>
                                        Although these rewards don't seem as enticing as those from other casino's loyalty programs, ZetCasino does offer other exclusive rewards to their VIP players, especially at the highest levels.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Bonus only available after contacting support</div>
                                        </div>
                                    </div>
                        ...
                        <div id="lookFeel-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        Black and yellow like a bee, ZetCasino has a fun color-scheme that goes well with its casual art style.
                                    </div>
                                    <div>
                                        However, there's nothing unusual or original about it, which gives the casino a certain cookie-cutter feel.
                                    </div>
                                    <div>
                                        Despite its bee-like colors, the casino isn't too busy, with only the necessary elements on display:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            There is a promotional banner at the top, with the main offers on rotation.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            The casino's top games are displayed right under it. You can play them and even browse through all of ZetCasino's slot games right there.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            On the left, you can switch between the live casino and the casino games.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            You can also find a casino feed, where recent wins and welcome messages are displayed.
                                        </div>
                                    </div>
                                    <div>
                                        As for performance, we've experienced smooth and fast navigation throughout the website, both on desktop and mobile devices.
                                    </div>
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Intuitive layout</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Unremarkable look</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="gameSelection-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        With more than 2,000 games on offer from 40 different studios, ZetCasino has an impressive portfolio.
                                    </div>
                                    <div>
                                        They come in all shapes and sizes as well, including our favorites: provably fair games, provided by BGaming.
                                    </div>
                                    ...
                                    <div className="text-xl font-bold mt-5">
                                        Slots And Jackpots At ZetCasino
                                    </div>
                                    <div>
                                        High RTP slot machines are at the heart of ZetCasino.
                                    </div>
                                    <div>
                                        Here, you can play 1,800+ slots from a plethora of providers. All the market-leading studios are available, such as Yggdrasil, Betsoft, Quickspin, and more.
                                    </div>
                                    <div>
                                        You might also want to check out games by up-and-coming providers Tom Horn and Skywind. Games like the official Rambo game and Star Trek; The Next Generation are definitely worth a try. 
                                    </div>
                                    <div>
                                        Unfortunately, a few top-dogs are missing from ZetCasino, namely NetEnt and Microgaming.
                                    </div>
                                    <div>
                                        ZetCasino's slots section is also the home of its jackpot games. These can get a bit lost in the middle of thousands of different titles.
                                    </div>
                                    <div>
                                        Unless you know what you're looking for, finding a jackpot game at ZetCasino can be a bit tricky.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Table Games And Live Casino
                                    </div>
                                    <div>
                                        If you are more into table games, there are separate sections for roulette, video poker, and blackjack for your convenience. 
                                    </div>
                                    <div>
                                        Baccarat, bingo, and other classic games can be found in the table game section. 
                                    </div>
                                    <div>
                                        If you are really into poker, you might enjoy the video poker section as well. And if you prefer table games with a more interactive touch, you can always check out the live casino.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Many providers to choose from</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Nice game offer</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Games with high RTP</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">NetEnt and Migrogaming not available</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No separate jackpot section</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Independently checked games at a licensed casino
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        Not only is ZetCasino licensed by the government of Curaçao, but all its games are also tested by <a href="https://gaminglabs.com/" target="_blank" rel="noreferrer" className="font-bold text-blue-600">Technical Systems Testing</a> (an independent organization, now part of GLI), ensuring the website's fairness and randomness. 
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            With this double-check in place, there is a strong signal that this casino is safe and fair.
                                        </div>
                                    </div>
                                    <div>
                                        However, ZetCasino's license does exclude gameplay from a few countries. Players from the United States or the United Kingdom, for instance, can't play here.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Is My Privacy Protected At ZetCasino?
                                    </div>
                                    <div>
                                        ZetCasino goes above and beyond its license requirements when it comes to KYC and identity checks.
                                    </div>
                                    <div>
                                        Unlike other blockchain casinos, you have to provide a valid address and telephone number right on registration. This means that your anonymity isn't guaranteed here. 
                                    </div>
                                    <div>
                                        The casino does use SSL encryption to protect your personal data, however, which means the details you do provide are likely to be safe.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Independently checked games</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No anonimity</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="payment-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        ZetCasino is a fiat-casino first, where you can pay (and exclusively play) with the following currencies:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        However, this casino does offer cryptocurrency payments:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        You will be able to <span className="font-bold">deposit and withdraw</span> with the previously mentioned four coins, but they will be <span className="font-bold">immediately converted</span> into one of the available fiat currencies.
                                    </div>
                                    <div>
                                        Deposits using cryptocurrencies can be immediate, but <span className="font-bold">withdrawals tend to be a bit slow</span> (especially if you have to complete a KYC check) and can take up to 48 hours.
                                    </div>
                                    <div>
                                        Furthermore, there are <span className="font-bold">withdrawal limits that only go as high as €20,000 per month</span>, depending on your VIP level. This is a relatively small number, making the casino perhaps unfit for high rollers.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Many payment options</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Instant crypto deposits</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Only 4 cryptocurrencies available</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Slow withdrawals</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Gameplay only in fiat</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Always available, just not always by phone
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        If you have questions, you have several ways to get in touch with ZetCasino.
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        Before you do, however, we recommend you check the casino's FAQ page. For more general questions, you might find your answer there.
                                    </div>
                                    <div>
                                        If you do choose to contact the support team, you'll be glad to find out you can reach them 24/7 via email or live chat.
                                    </div>
                                    <div>
                                        Live chat is available in 7 different languages, which isn't exactly impressive but still quite acceptable. 
                                    </div>
                                    <div>
                                        You can also call during weekdays from 10am - 8pm, GMT. You can choose between a European and a Russian phone number.
                                    </div>
                                    <div>
                                        In our experience, the customer support team is knowledgeable and helpful.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Several languages supported</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Phone support unavailable on weekends</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="faq-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            ...
                            <div className="flex flex-row gap-x-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-sm text-gray-500">
                                        In case of any doubt, no need to break glass
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    1. Can I deposit using Bitcoin at ZetCasino?
                                </div>
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        Indeed you can! Besides Bitcoin, you can also deposit and play with Ethereum, Litecoin, and Ripple. However, all your deposits will be converted into fiat money immediately, and you can play using fiat money only.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                {openFAQ2 &&
                                    <div className="text-black mt-5">
                                        We believe so. <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">ZetCasino</a> is licensed by the government of Curaçao and has independently verified games. There are also provably fair games available. If you do have a bad experience at this casino, do share in our comment section.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    3. Does ZetCasino have withdrawal limits?
                                </div>
                                {openFAQ3 &&
                                    <div className="text-black mt-5">
                                        Unfortunately, it does. The limits themselves depend on your VIP level and only go as high as €20,000.
                                    </div>
                                }
                            </div>
                        </div>
...
export default ZetCasinoGameReview;