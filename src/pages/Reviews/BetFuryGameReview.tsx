...
// review images
import reviewImg1 from "../../Assets/images/reviews/16-betfury-game/1-betfury-review.png";
import reviewImg2 from "../../Assets/images/reviews/16-betfury-game/2-betfury-review.png";
import reviewImg3 from "../../Assets/images/reviews/16-betfury-game/3-betfury-review.png";
...
const BetFuryGameReview = () => {
    const siteData = siteDatas[15];
                    ...
                    <div className="flex flex-col">
                            ...
                            <div className="flex flex-row gap-x-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-base">
                                        A gambling Dapp that feels like a 'real' casino
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="flex flex-col xl:flex-row gap-3">
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        ...
                                                        <div className="w-[230px]">Free faucet</div>
                                                    </div>
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                    ...
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                        <div className="w-[230px]">All players welcome</div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-start gap-x-3">
                                                    ...
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                                        <div className="w-[230px]">Flawed English</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div className="text-base">
                                        Similar to several other gambling Dapps, Betfury casino doesn't have a welcome bonus upon sign-up. However, <span className="bold-font">there is a free faucet, offering small amounts of free BTC</span> every 20 minutes.
                                    </div>
                                    <div>
                                        Called Free BetFury Box, the faucet is available to all players as soon as they register.
                                    </div>
                                    <div>
                                        The amounts offered are small, and its value is not guaranteed and can be increased or decreased by the casino at any time. Therefore, this is not a reliable way to earn Bitcoin.
                                    </div>
                                    <div>
                                        However, it's a great way to put BetFury's games to the test before making your first deposit.
                                    </div>
                                    <div>
                                        You can also buy into other boxes, which offer considerably larger payouts in Bitcoin and other cryptocurrencies.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Other BetFury Casino Bonuses
                                    </div>
                                    <div>
                                        Unlike other gambling Dapps, BetFury casino is positively bursting with promotions, such as:
                                    </div>
                                    
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Up to 25% Cashback</span>: this offer is available to all users. The cashback's value depends on the user's VIP level, starting at 2% for newcomers.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Tournaments</span>: compete for real-money prizes in different cryptocurrencies.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Social Promotions</span>: receive prizes for sharing your best bets and wins.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            <span className="font-bold">Daily Tasks</span>: win BTC for completing achievements (not available at the VIP's program lowest level).
                                        </div>
                                    </div>
                                    <div>
                                        What's more, there is a VIP program called Rank System. High-tier players will take advantage of bit BTC bonuses, the full 25% cashback, exclusive promotions, and more.
                                    </div>
                                    <div>
                                        Players can also earn a share of the house's profit when staking BetFury's in-house tokens: BFG. You accumulate them when placing real money bets.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Shared house profits</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                        ...
                        <div id="lookFeel-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        BetFury is a <span className="font-bold">highly-functional and interactive</span> casino with easily accessible games and promotions.
                                    </div>
                                    <div>
                                        Your playing experience is likely to feel social and engaged due to a <span className="font-bold">player's chat on the right-hand side</span> of your screen.
                                    </div>
                                    <div>
                                        Creating an account is a quick and fast process, and so are other account-related actions, such as withdrawing and depositing.
                                    </div>
                                    <div>
                                        This a gambling Dapp that doesn't look rough around the edges. Instead, it has a fun and original design (revolving around BetFury casino's pet raccoon), which is consistently applied throughout the website.
                                    </div>
                                    <div>
                                        In contrast, BetFury's texts, unfortunately, have <span className="font-bold">several grammatical mistakes and typos</span>. For the most part, however, these errors are minor, and the texts are understandable.
                                    </div>
                                    <div>
                                        As such, the level to which <span className="font-bold">BetFury's grammatical faux-pas can affect your experience</span> depends on how much you care about language correction.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Mobile Experience at BetFury
                                    </div>
                                    <div>
                                        BetFury is, evidently, a mobile-first casino designed to offer an optimal gambling experience on handheld devices.
                                    </div>
                                    <div>
                                        There is a lot to do - and click on - at BetFury casino, which could have created a confusing and overwhelming experience for those playing from a smaller screen. However, the casino's design team simplified navigation on mobile devices to prevent clutter.
                                    </div>
                                    <div>
                                        From our experience, the website performed well on slower mobile internet connections. 
                                    </div>
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Fun and original design</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Consistent theme</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Simplified mobile navigation</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Streamlined account creation</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Player's chat</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Grammatical mistakes and typos</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="gameSelection-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Provably fair and reputable providers
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        BetFury follows the trend of most other casino Dapps, providing internally-developed games. As expected, all of these games are provably fair.
                                    </div>
                                    <div>
                                        However, BetFury also features <span className="font-bold">over 1,000+ games from many known brands</span>, including:
                                    </div>
                                    ...
                                    <div className="text-xl font-bold mt-5">
                                        BetFury Casino Original Games
                                    </div>
                                    <div>
                                        At some point during your BetFury journey, you're likely to come across their internally developed games.
                                    </div>
                                    <div>
                                        Although common on other gambling Dapps, these 100% provably fair and crypto-friendly games are harder to find at more mainstream websites:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        BetFury's crash game is, perhaps, the casino's calling-card. It's undeniably one of the most visually appealing Bitcoin crash games out there.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Slot Machines And Jackpots
                                    </div>
                                    <div>
                                        Beloved providers like Quickspin and Yggdrasil are part of BetFury casino's slot machine collection, alongside other less-known but equally impressive brands such as Habanero.
                                    </div>
                                    <div>
                                        Whether you prefer whimsical games such as Pragmatic's Sweet Bonanza or classic slots like Amatic's Hot Twenty, you're likely to find something that suits you.
                                    </div>
                                    <div>
                                        Unfortunately, some high-profile providers - such as Microgaming - are missing. 
                                    </div>
                                    <div>
                                        There is also an interesting collection of jackpot games, where you can play for substantive prizes.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Live Casino And Table Games
                                    </div>
                                    <div>
                                        With its varied live casino and table game collection, BetFury shows that it can compete with other gambling Dapps and non-decentralized casinos alike.
                                    </div>
                                    <div>
                                        Evolution Gaming's best live roulette and live blackjack tables share the stage with live casino game shows and other live dealer classics from Evolution and other, smaller studios.
                                    </div>
                                    <div>
                                        A vast collection of video table games is also available, featuring games from brands like Spinomenal, Tom Horn, and Habanero.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Provably fair in-house games</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Household brands present</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Comprehensive live casino</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No NetEnt or Microgaming</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Increased accountability due to its new gambling license
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        BetFury casino has applied for and obtained a <a href="https://licensing.gaming-curacao.com/validator/?lh=38f2b08dce0259dc85f0e53aee4c35df&rlh=5999663be98f46d9cfaf76354bcfbfed" target="_blank" rel="noreferrer" className="text-blue-600">gambling license from the government of Curaçao</a>.
                                    </div>
                                    <div>
                                        The casino currently does not exclude players from any countries or regions. However, since they acquired the new license, a few locations might be restricted in the future.
                                    </div>
                                    <div>
                                        We would also like to point out a few additional safety features:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            You can protect your account with 2-FA (two-factor authentication).
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            BetFury's internally developed games are provably fair.
                                        </div>
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Is BetFury Legit?
                                    ...
                                    <div>
                                        BetFury is a licensed casino with commendable safety features such as two-factor authentication.
                                    </div>
                                    <div>
                                        However, this is still a relatively recent brand without an established reputation in the blockchain gambling community.
                                    </div>
                                    <div className="divHasTempBG2 flex flex-col p-10 rounded-xl w-80 xl:w-[450px]">
                                        <div className="text-white font-bold text-2xl">
                                            Do make sure you read through and follow the casino's terms and conditions before creating a new account.
                                        </div>
                                    </div>
                                    <div>
                                        For instance, players with multiple accounts can risk account closure and having their winnings withheld.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">All players accepted</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                        ...
                        <div id="payment-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Hassle-free payments, but more coins would be welcome
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        Don't expect fiat payments at BetFury casino. As expected, this is a crypto-only gambling Dapp, where you can pay with:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        Do note that <span className="font-bold">most bonuses are exclusive to Bitcoin and Ethereum</span> players.
                                    </div>
                                    <div>
                                        However, you can also accumulate and play with BFG, the company's own token. As stated above, doing so will earn you benefits, namely a share of the house's profits.
                                    </div>
                                    <div>
                                        Although you can't play with fiat money, you can use it to <span className="font-bold">buy coins directly on the website</span>.
                                    </div>
                                    <div>
                                        Withdrawals are fast, hassle-free, and cheap, although some conditions do apply:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            All deposits are free and nearly instant.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            There are no minimum nor maximum deposit limits for any of the available coins.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            Minimum withdrawal amounts do apply - 0.00005 BTC or equivalent.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            BTC withdrawals can be slow (up to 24h) or fast (0-2h). Both options have a fixed cost, although slow withdrawals are considerably cheaper (0.000075 BTC vs. 0.00025 BTC).
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            A 0.003 ETH transaction fee applies for Ethereum withdrawals.
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Flexible BTC transactions</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">No deposit limits</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Common altcoins missing</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Withdrawal limits and fees (ETH and BTC)</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        As we mentioned above, BetFury casino is available in English, and so are all its customer support platforms. No other language is supported.
                                    </div>
                                    <div>
                                        If you have questions about BetFury, you can browse the many help pages and FAQs that are available throughout the website.
                                    </div>
                                    <div>
                                        However, you can also reach one of the help channels at your disposal:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{color: "green"}}/>
                                        <div>
                                    ...
                                    <div>
                                        Unfortunately, no telephone or email support are available. Alternatively, the casino has an extensive social media presence:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{color: "green"}}/>
                                            <div>
                                                <a 
                                                    href="https://t.me/betfuryofficialchannel"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Telegram
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://twitter.com/betfury_io"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Twitter
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://www.instagram.com/betfury.io/"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Instagram
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://steemit.com/@betfury-steem"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Steemit
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://www.reddit.com/user/BetFury_io"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Reddit
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://bitcointalk.org/index.php?topic=5276159"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    BitcoinTalk
                                        ...
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            ...
                                            <div>
                                                <a 
                                                    href="https://www.youtube.com/channel/UCTlThuhFNg6yFw8hak4upDw"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                                    Youtube
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Comprehensive FAQs</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Strong social media presence</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                        ...
                        <div id="faq-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            ...
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    1. Can I use fiat currencies at BetFury?
                                </div>
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        Unfortunately, no. <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">BetFury</a> is a crypto-only gambling Dapp where you can only pay with fiat currencies. You can, however, buy coins directly on the website with fiat money.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    2. Can I deposit using Bitcoin at Betfury casino?
                                </div>
                                {openFAQ2 &&
                                    <div className="text-black mt-5">
                                        You can! <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">BetFury</a> casino's main currencies are, in fact, Bitcoin and Ethereum. There are many BTC bonuses and even a BTC faucet, where you can win small amounts of Bitcoin every day for free.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    3. Does Betfury casino offer a welcome offer?
                                </div>
                                {openFAQ3 &&
                                    <div className="text-black mt-5">
                                        <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">BetFury</a> casino does not offer a welcome offer. However, you can free Bitcoin daily and participate in many promotions and tournaments.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                {openFAQ4 &&
                                    <div className="text-black mt-5">
                                        Its new gambling license has certainly helped with <a href={"https://" + siteData.link} target="_blank" rel="noreferrer" className="text-blue-600">BetFury's</a> legitimacy. For the most part, this is a trusted casino with commendable safety features such as 2-factor authentication. However, this is still a relatively recent brand that will have to build its reputation.
                                    </div>
                                }
                            </div>
                        </div>
...
export default BetFuryGameReview;