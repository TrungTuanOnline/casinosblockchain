    ...
    return (
        <Box className="bg-gray-100 flex flex-col items-center">
            ...
            <div className="w-11/12 flex flex-col py-10 gap-y-5">
                {/* header */}
                <div className="bg-white rounded-xl flex flex-col md:flex-row justify-between p-5">
                    <div className="flex flex-row justify-between">
                        ...
                        <div className="flex flex-col justify-between py-2 ml-5">
                            ...
                            <div className="flex flex-col md:flex-row gap--1 md:gap-x-5">
                    ...
                    <div className="flex flex-row justify-end items-end gap-x-5">
                        <div>
                            <Button
                                className="text-blue border border-inherit border-solid h-10 text-xs sm:text-base"
                                href={"/review/" + siteData.link}
                                endIcon={<div className="px-2 rounded-full bg-orange-400 text-white  text-xs sm:text-base">{siteData.bonus}</div>}
                            >
                                Claim Bonus
                            </Button>
                        </div>
                        <div>
                            <Button
                                className="text-white h-10  text-xs sm:text-base"
                                variant="contained"
                                color="primary"
                ...
                <div className="flex flex-row">
                    <div className="flex flex-col">
                        {/* Overview */}
                        <div className="bg-white flex flex-col rounded-xl p-5 gap-y-10">
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-3">
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        ...
                                                        <div className="text-base">Very low house edge</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">Daily wheel spin (for free)</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">Provably fair original games</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">65+ cryptocurrencies accepted</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">Stellar social features</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">Original promotions</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-green-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                                        <div className="text-base">Cryptocurrency exchange</div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-red-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                                        <div className="text-base">No fiat payments</div>
                                                    </div>
                                                    <div className="flex flex-row items-center gap-x-3">
                                                        <div className="bg-red-300 rounded-full text-base w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                                        <div className="text-base">Lacks a deposit bonus</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="flex flex-col justify-center w-min order-first md:order-last gap-y-5">
                        ...
                        {/* Bonus */}
                        <div className="bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            {/* header */}
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div className="divHasTempBG2 flex flex-col p-10 rounded-xl w-80 sm:w-[450px]">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Daily chance to win 5 BTC</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Wager-free crypto rewards</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>VIP club</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-red-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                            <div>Few traditional promotions</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-red-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                            <div>No free spin offers for slots</div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-red-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                            <div>Occasional language issues</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div className="bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div className="flex flex-col min-w-[320px] md:min-w-[500px] border rounded-xl">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Very low house edge</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Provably fair games</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>100+ live tables</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Attractive original games</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Plenty of known providers</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Crypto Gambling Foundation seal</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>RNG tested and verified</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Gambling license</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-red-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                            <div>No established reputation</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div className="bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div>
                                        <a href="https://degenverse.com/" target="_blank" className="text-blue-400">Degenpass</a> is particularly noteworthy as it's a <span className="font-bold">virtual entry pass to the Degenverse ecosystem</span> and a range of eligible casinos.
                                    </div>
                                    <div>
                                        As <a href="https://casinosblockchain.io/metaverse-gambling/" target="_blank" className="text-blue-400">Metaverse gambling</a> grows in importance and popularity, so will NFTs. By offering the Degenpass, BC.Game is already one step ahead of the competition and proving they're at the edge of innovation when it comes to the online gambling industry.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Large variety of cryptos (66+)</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Fast and easy transactions</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>No invasive KYC</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>In-house stablecoin</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                            ...
                            <div className="flex flex-col md:flex-row gap-20 items-center md:items-start">
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Friendly support team</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                            <div>Skype and Telegram support</div>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-green-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-green-900">+</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row items-center gap-x-3">
                                            <div className="bg-red-300 rounded-full w-5 h-5 flex text-center justify-center items-center text-red-900">-</div>
                                            <div>Support only in English</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        {/* FAQ */}
                        <div className="bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            {/* header */}
                            <div className="flex flex-row gap-x-5">
                                <div className="flex justify-center items-center">
                            ...
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        Yes, <a href={"https://" + siteData.link} target="" className="text-blue-400">BC.Game</a> is licensed and reputable. They also have provably fair games, which are impossible to be rigged.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
