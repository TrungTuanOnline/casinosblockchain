...
// review images
import reviewImg1 from "../../Assets/images/reviews/24-wink-game/1-wink-review.png";
import reviewImg2 from "../../Assets/images/reviews/24-wink-game/2-wink-review.png";
import reviewImg3 from "../../Assets/images/reviews/24-wink-game/3-wink-review.png";

// country flag
import { CN, GB } from 'country-flag-icons/react/1x1';
...
const WinkGameReview = () => {
    const siteData = siteDatas[23];
                    ...
                    <div className="flex flex-col">
                            ...
                            <div className="flex flex-row gap-x-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-base">
                                        Play at the one of its kind Dapp
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="flex flex-col xl:flex-row gap-3">
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        ...
                                                        <div className="w-[230px]">Has a great reputation</div>
                                                    </div>
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                        <div className="w-[230px]">Big game offer for Dapp</div>
                                                    </div>
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                ...
                                                <div className="flex flex-col gap-y-3">
                                                    ...
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                                        <div className="w-[230px]">Limited payment methods</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                                ...
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Wink at this Dapp and become a winner with Win Tokens
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div className="text-base">
                                        At Wink you don't get a welcome bonus of the sort you might be used to from playing in online casinos.
                                    </div>
                                    <div>
                                        You can however, receive WIN Tokens, but these are also a bit different from the Tokens you usually earn at other Dapps. These work more as a currency that allows you to be treated as a VIP at Wink.
                                    </div>
                                    <div>
                                        Examples of benefits that you can receive are lower house edges, rewards and other experiences like poker tournaments and voting rights as to what will happen to the Dapp.
                                    </div>
                                    <div>
                                        In a way this helps the feeling that you're playing on a decentralized casino.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Earn WIN Tokens</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">VIP program</div>
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No bonus</div>
                                        </div>
                                    </div>
                        ...
                        <div id="lookFeel-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        The first thing that you'll notice when navigating to the Wink website, is the logo that includes a winky face to welcome you. This is already a nice start. Right after that you get to choose the game you want to play.
                                    </div>
                                    <div>
                                        It is a nice looking site, although not on par with some of the best looking casinos out there - we can forgive this since this is a casino Dapp. After a while of getting used to, you won't have any trouble finding what you want.
                                    </div>
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Welcoming style</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Nice looking Dapp</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Not always easy to find the information you need</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="gameSelection-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        The games offered by Wink are divided into three large categories: Dice, Live games and Rake.
                                    </div>
                                    <div>
                                        In the Dice section, you can find games like Dice, Moon, Ring, Duel and Mine.
                                    </div>
                                    <div>
                                        The Live section is a bit more confusing though. It has a casino subsection that offers slots, table games and live casino games, which is pretty clear.
                                    </div>
                                    <div>
                                        However, the sports subsection is still in development and it's unclear what exactly it'll offer.
                                    </div>
                                    ...
                                    <div>
                                        We have to give Wink the credit for incorporating live casino games. It's not something you'll see everyday on casino Dapps. Also, you can find slots by other top providers like NetEnt.
                                    </div>
                                    <div>
                                        This offer of casino games is quite good for a Dapp with games by Betsoft and Evolution Gaming.
                                    </div>
                                    <div>
                                        Finally, the Rake section offers the chance to play poker in a casino setting.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Big casinogame offer for Dapp</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Live casino games</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Slots by known providers</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Typical Dapp games are missing</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        Not only does Wink offer a number of provably fair games, it also has <span className="font-bold">two gaming licenses</span>; one from Curaçao and one from Costa Rica.
                                    </div>
                                    <div>
                                        However, you already knew you were safe at this Dapp that offers voting rights to players and collaborates with Binance. The site is available in English and simplified Chinese.
                                    </div>
                                    <div>
                                        Also, keep in mind that you're playing on a casino Dapp. This means that when trying to open a game, you'll be asked to login to your TRONLink wallet.
                                    </div>
                                    <div>
                                        Your wallet will connect directly to the game, which guarantees an immediate payout of any winnings.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Two licenses</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Casino Dapp</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                        ...
                        <div id="payment-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        The first and main coin that is accepted at Wink is the widely acknowledged cryptocurrency Tron. In order to carry out deposits and withdrawals with this currency, you must link you <a href="https://chrome.google.com/webstore/detail/tronlink%EF%BC%88%E6%B3%A2%E5%AE%9D%E9%92%B1%E5%8C%85%EF%BC%89/ibnejdfjmmkpcnlpebklmnkoeoihofec" target="_blank" rel="noreferrer" className="text-blue-600">TRONLink</a> wallet to Wink.
                                    </div>
                                    <div>
                                        While this might feel like an extra step, bear in mind that this is what will guarantee that the casino doesn't fiddle with payments to its players.
                                    </div>
                                    <div>
                                        Regarding the accepted cryptocurrencies, it's quite a limited number of options, but Wink promises to increase the number of accepted coins soon. At the moment, the casino accepts:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Fast, honest payments</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Not many currencies accepted</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        In case of any questions, you can always divert to the help center where you can find nearly all the information you need. If you still need additional help you can always reach out to the social media profiles on <a href="https://twitter.com/WINkorg" target="_blank" rel="noreferrer" className="text-blue-600">Twitter</a> and T.
                                    </div>
                                    <div>
                                        There's also an email address available for support, but there's no live chat.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Help Center</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Support email address</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                        ...
                        <div id="faq-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            ...
                            <div className="flex flex-row gap-x-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-sm text-gray-500">
                                        Guess you were wondering about it as well
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    1. How do the provably fair games work at Wink?
                                </div>
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        They are secured through smart contracts on the Tron network. Which works the same as all other provably fair games, with the exception of it using another network.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    2. Can I not earn a part of the revenue like at other Dapps?
                                </div>
                                {openFAQ2 &&
                                    <div className="text-black mt-5">
                                        Yes, you can. While playing you can earn DICE, which work like the tokens that you are used to at other Dapps. These entitle you to a part of the Wink revenue.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    3. Are Wink games available on mobile devices?
                                </div>
                                {openFAQ3 &&
                                    <div className="text-black mt-5">
                                        Yes, they are. However, you need to use a compatible wallet in order to be able to play the games.
                                    </div>
                                }
                            </div>
                        </div>
