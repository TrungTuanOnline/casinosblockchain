                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div>
                                        Edgeless holds a reputable online gambling license from the government of Curaçao. This license, unfortunately, means that players from a few countries (including the United States) are excluded from the casino.
                                    </div>
                                    <div>
                            ...
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        Though Edgeless casino is a legitimate business, operating under a Curaçao license, its player base seems to be dwindling and we cannot recommend it.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
